...
**Status:** OPEN · awaiting ballot before any payroll schema  
...
2. Draft AuthZ permission catalog candidates: `hr.payroll.view`, `hr.payroll.manage` (names provisional)
3. No DEFAULT partition work; Schema ALTER = **NONE** in this start commit
