...
/**
 * School-scope gate for Timetable authorization.
 */
final class TimetableSchoolAccessService
{
    ...
    public function canAccessTimetable(User $user, ?int $targetSchoolId = null): bool
    {
