...
/**
 * School-scope gate for Vocational authorization.
 */
final class VocationalSchoolAccessService
{
    ...
    public function canAccessVocational(User $user, ?int $targetSchoolId = null): bool
    {
