...
/**
 * Expand students.student_documents.document_type for admission ID / residence / graduation scans.
 * Types 11–19 map to vocational admission document slots (metadata only — binary in object storage).
 */
